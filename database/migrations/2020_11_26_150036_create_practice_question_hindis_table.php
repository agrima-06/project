    ...
    public function up()
    {
        Schema::create('practice_question_hindis', function (Blueprint $table) {
           ...
           // $table->integer('practice_question_hindi_id')->nullable();
            ...
            $table->string('instruction')->nullable();//THIS IS FOR BASIC INSTRUCTION
            $table->string('comprehensive_id')->nullable();//THIS IS FOR BASIC INSTRUCTION
            $table->enum('type', ['objective', 'comprehensive_id']);    
