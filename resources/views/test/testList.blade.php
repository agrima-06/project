    ...
    <div class="module message">
      ...
      <div class="module-option clearfix">
        ...
        <div class="pull-right">
          ...
          <a href="{{route('objectivetest.create')}}" class="btn btn-warning float-right mb-2">
            Create Test
          </a>        
          </div>
        </div>
      ...
      <div class="module-body table">               
        ...
        <table class="table table-message">
          <tbody>
            <tr class="heading">
              <td class="cell-title centerText">Test</td>
              <td class="cell-title centerText">Exam</td>
              <td class="cell-title centerText">Aspirants</td>
              <td class="cell-title centerText">Subjects</td>
              <td class="cell-title centerText">Duration</td>
              <td class="cell-title centerText">Action</td>
            </tr>
          @foreach($tests as $test)
                <tr class="task">
		              <td class="cell-title centerText"><div><a href="{route('school.class.profile',[$relation->school_id, $relation->sclass_id, $relation->section_id])}">1</a></div></td>
		              <td class="cell-title centerText"><div><a href="{route('school.class.profile',[$relation->school_id, $relation->sclass_id, $relation->section_id])}">{{$test->exam}}</a></div></td>
                  <td class="cell-title centerText"><div><a href="{route('school.class.profile',[$relation->school_id, $relation->sclass_id, $relation->section_id])}">@if($test->published == 0) Un Published @elseif($test->published == 1) {$test->testshareds[0]->section_id} @elseif($test->shared == 2) My School @elseif($test->shared == 3) Public  @endif</a></div></td>
                  <td class="cell-title centerText">
                    Subjects loop
                  </td>                  
                  <td class="cell-title centerText">60Min</td>
		              <td class="cell-title centerText"">
                    <a href="{{route('single.test', $test->id)}}" class="btn btn-primary btn-sm">View</a>
		              </td>
		            </tr>
          @endforeach
          </tbody>
